...
questionsF.push(new Question("Je cède le passage :", [0, 1, -1, -1], ["À gauche", "À droite", "", ""]));
...
questionsM.push(new Question("Pour éviter un accident sur un coup de fatigue, je peux :", [1, 1, 1, 1], ["Emprunter des itinéraires plus rapides", "M'arrêter régulièrement", "Respecter les limitations de vitesse", "Etre prudent (c'est vraiment ma voiture donc ça n'arrive pas qu'aux autres !🙏🏻)"]));
...
questionsM.push(new Question("J'entre sur une autoroute de manière imminente :", [0, 0, 1, -1], ["Je vérifie l'angle mort gauche, j'accélère puis je mets le clignotant gauche", "J'accélère, je mets mon clignotant gauche puis je regarde l'angle mort gauche", "Je mets mon clignotant gauche, je regarde mon angle mort gauche, j'accélère en étant vigilant", ""]));
...
questionsM.push(new Question("Un voyant de couleur orange peut signifier :", [1, 1, 0, 1], ["Un avertissement sur un potentiel danger imminent", "Un éclairage pouvant gêner d'autres automobilistes", "La nécessité de m'arrêter immédiatement", "Un réservoir de carburant presque vide"]));
...
questionsD.push(new Question("Quel est l'état de santé de grumpy cat? :", [1, 0, 0, -1], ["il est décédé snif", "il va bien", "il est malade", ""]));
questionsD.push(new Question("Comment s'appelle ce chien??? :", [0, 1, 0, 0], ["VodkaPomme", "Diabolo", "Scooby", "Diablo"]));
...
questionsD.push(new Question("Plus le temps il faut choisir! Qui écrasez-vous pour sauver les autres? :", [0, 1, 0, -1], ["l'Enfant", "l'Adulte", "La mamie", ""]));
questionsD.push(new Question("Vous trouvez un oeuf de Yoshi pendant votre Pique-nique sur l'aire d'autoroute quelle est votre réaction? :", [0, 1, 0, -1], ["Je le garde pour la contreBande", "Je le remet aux autorités compétentes", "Vous utilisez l'oeuf pour faire une omelette", ""]));
questionsD.push(new Question("Vous voyez en tant que pieton un Bébé pinguoin perdu au milieu de la route (il pleure très fort et de façon insupportable) que faite vous? :", [1, 1, 1, 0], ["Je le laisse au milieu de la route", "Je l'aide a retrouver sa maman", "Je le jette dans le vide ou dans la bouche d'égout la plus proche", "La réponse D"]));
...
questionsD.push(new Question("Dans Doctor Who à quelle espèce appartient le docteur? :", [0, 0, 1, 0], ["Les daleks", "CyberMan", "Seigneurs du temps", "Les Anges"]));
questionsD.push(new Question("Combien de dinosaures y'a t'il sur la map parc Dino Dino? (on ne compte pas les doublon):", [0, 0, 1, 0], ["1", "4", "5", "8"]));
questionsD.push(new Question("COMMENT PREND-T-ON UN ROND POINT (EN FRANCE)? :", [0, 1, 0, 0], ["Par la gauche", "Par la droite", "On le coupe (vous êtes mort)", "on le prend pas"]));
questionsD.push(new Question("Pourquoi les fantômes sont-ils de si mauvais menteurs? :", [0, 0, 1, -1], ["Par ce qu'on les entend pas", "Par ce qu'on voit à travers eux", "Parce qu’on peut lire à travers eux", ""]));
questionsD.push(new Question("Dans quel jeu apparaît pour la première fois le King Boo? :", [0, 1, 0, -1], ["Mario party 3", "Luigi's Mansion", "Mario Kart double Dash", ""]));
...
questionsD.push(new Question("Dans combien de Licences apparaît 'Terry Bogard?' :", [1, 0, 0, -1], ["12", "8", "3", ""]));
...
questionsD.push(new Question("Que signifie le nombre 2147483647 ? :", [0, 0, 1, -1], ["la population mondiale en 2030", "la valeur max d'un booléen en code", "le compte en banque d'Antho s'il était' payé à faire des jeux de mots pourris", ""]));
...
questionsD.push(new Question("En combien de cases est divisée la map de Zelda Wind Waker? :", [1, 0, 0, 0], ["49", "35", "64", "21"]));
...
questionsD.push(new Question("Quelle est la toute première console répertoriée au monde? :", [1, 0, -1, -1], ["l'Odyssey de Magnavox", "l'Ataris PONG", "", ""]));
